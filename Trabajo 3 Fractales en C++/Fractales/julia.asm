...
;  
;
; julia.asm sólo para 32bits.
;
;  Tenemos que:
;    datos = {x_inicial xi, rengón estático yi, x_incremento xincre, cx, cyi}
...
global  _julia_renglon
global  julia_renglon
...
julia_renglon:
        ...
        fld     qword [eax+24]          ; cx que el usuario puso
        fstp    qword [_cx]             ; con un _ para no confundirlo con el registro
		fwait
        
		fld     qword [eax+32]          ; cyi que el usuario puso
        fstp    qword [cyi]             ;
		fwait
